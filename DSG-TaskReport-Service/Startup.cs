...
using DSG_TaskReport_Service.Controller_Service;
...
namespace DSG_TaskReport_Service
{
    public class Startup
    {
        ...
        {
            //依赖注入
            services.AddSingleton<ILogService, LogServiceImpl>();
            services.AddSingleton<ITaskReportControllerService, TaskReportControllerImpl>();

            services.AddSingleton<ITaskReportService, FreqModuleService>();
            services.AddSingleton<ITaskReportService, FreqSampleService>();
            services.AddSingleton<ITaskReportService, IllegalSignalCatch>();
            services.AddSingleton<ITaskReportService, SignalStatusWarnService>();
            services.AddSingleton<ITaskReportService, SignalWatchService>();
            services.AddSingleton<ITaskReportService, UseAssessService>();

            services.AddSingleton<IDailyTaskReportService, DailyFreqReportService>();
            services.AddSingleton<IDailyTaskReportService, DailySignalReportService>();
            ...
            services.AddMvc(option =>
            {
                ...
                option.Filters.Add<ModelActionFilter>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime aft)
        {
            ...
            string staticFilePath = Module.StaticFilePath;
